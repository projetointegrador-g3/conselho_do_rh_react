...
function Departamentos() {
  return (
    <div className='container'>
      <div className="flex items-center justify-between pr-18 gap-2 m-16 ">
        <h1 className="text-3xl font-bold flex items-center gap-2 ">
          <Folder /> Departamentos
        </h1>
        <button 
          className="bg-zinc-200 border-none cursor-pointer rounded p-2 flex items-center text-zinc-500 hover:text-zinc-800 hover:scale-104" 
